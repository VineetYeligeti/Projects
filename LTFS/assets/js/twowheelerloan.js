...
$(document).ready(function() {
    ...
    $(document).on('click', '#twltabs .service-list-item', function() {
        $('html, body').animate({
            scrollTop: $("#twltabs").offset().top - 80
        }, 200);
    });
...
// Do more Two Wheeler loan Tabs Start
function doMoreTabs() {
...
// Do more Two Wheeler loan Tabs End


// Two Wheeler loan Related products start
...
// Two Wheeler loan Related products End

// Know More about Two Wheeler loan Slider Start
...
// Know More about Two Wheeler loan Slider End
...
function calculateLoanDetails(p, r, emi) {
    ...
    function nhresetAmount() {
        document.querySelector("#nhresetData").addEventListener("click", (event) => {
            ...
            // R = 5000000;
            $('#nhloan-Requirement-range').val(10000).trigger('input').trigger('change');
...
function spOffer() {
    $('.special-cards').hover(
        function(){ 
          $(".special-cards.active").addClass('inactive').removeClass('active');
        },
        function(){ 
          $(".special-cards.inactive").addClass('active').removeClass('inactive'); 
        }
    );
}
