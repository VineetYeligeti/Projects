...
!function(e, t, n) {
    ...
    function s(e, t) {
        if ("object" == typeof e) for (var n in e) N(e, n) && s(n, e[n]); else {
            var o = (e = e.toLowerCase()).split("."), i = Modernizr[o[0]];
            if (2 == o.length && (i = i[o[1]]), void 0 !== i) return Modernizr;
            t = "function" == typeof t ? t() : t, 1 == o.length ? Modernizr[o[0]] = t : (!Modernizr[o[0]] || Modernizr[o[0]] instanceof Boolean || (Modernizr[o[0]] = new Boolean(Modernizr[o[0]])), 
            Modernizr[o[0]][o[1]] = t), r([ (t && 0 != t ? "" : "no-") + o.join("-") ]), Modernizr._trigger(e, t);
        }
        return Modernizr;
    }
    function l(e) {
    ...
    function c(e, n, r, o) {
        var i, s, l, u, c = "modernizr", d = a("div"), p = function() {
            var e = t.body;
            return e || ((e = a(b ? "svg" : "body")).fake = !0), e;
        }();
        if (parseInt(r, 10)) for (;r--; ) (l = a("div")).id = o ? o[r] : c + (r + 1), d.appendChild(l);
        return (i = a("style")).type = "text/css", i.id = "s" + c, (p.fake ? p : d).appendChild(i), 
        p.appendChild(d), i.styleSheet ? i.styleSheet.cssText = e : i.appendChild(t.createTextNode(e)), 
        d.id = c, p.fake && (p.style.background = "", p.style.overflow = "hidden", u = E.style.overflow, 
        E.style.overflow = "hidden", E.appendChild(p)), s = n(d, e), p.fake ? (p.parentNode.removeChild(p), 
        E.style.overflow = u, E.offsetHeight) : d.parentNode.removeChild(d), !!s;
    }
    function d(e, t) {
        return !!~("" + e).indexOf(t);
    }
    ...
    function v(t, r) {
        ...
        if ("CSSSupportsRule" in e) {
            ...
            return c("@supports (" + (i = i.join(" or ")) + ") { #modernizr { position: absolute; } }", function(e) {
    ...
    function g(e, t, r, i) {
        ...
        for (var f, c, p, m, h, g = [ "modernizr", "tspan", "samp" ]; !L.style && g.length; ) f = !0, 
        L.modElem = a(g.shift()), L.style = L.modElem.style;
        for (p = e.length, c = 0; c < p; c++) if (m = e[c], h = L.style[m], d(m, "-") && (m = l(m)), 
        L.style[m] !== n) {
    ...
    function y(e, t, n, r, i) {
        ...
        return o(t, "string") || o(t, "undefined") ? g(s, t, r, i) : function(e, t, n) {
            var r;
            for (var i in e) if (e[i] in t) return !1 === n ? e[i] : o(r = t[e[i]], "function") ? p(r, n || t) : r;
            return !1;
        }(s = (e + " " + P.join(a + " ") + a).split(" "), t, n);
    }
    var C = [], E = t.documentElement, b = "svg" === E.nodeName.toLowerCase();
    b || function(e, t) {
        function n(e, t) {
        ...
        function a(e, n, r) {
            return n || (n = t), v ? n.createElement(e) : (r || (r = i(n)), !(o = r.cache[e] ? r.cache[e].cloneNode() : C.test(e) ? (r.cache[e] = r.createElem(e)).cloneNode() : r.createElem(e)).canHaveChildren || S.test(e) || o.tagUrn ? o : r.frag.appendChild(o));
            var o;
        }
        function l(e, t) {
        ...
        function u(e) {
            e || (e = t);
            var r = i(e);
            return !x.shivCSS || h || r.hasCSS || (r.hasCSS = !!n(e, "article,aside,dialog,figcaption,figure,footer,header,hgroup,main,nav,section{display:block}mark{background:#FF0;color:#000}template{display:none}")), 
            v || l(e, r), e;
        }
        function f(e) {
        ...
        function c(e) {
            for (var t, n = e.attributes, r = n.length, o = e.ownerDocument.createElement(T + ":" + e.nodeName); r--; ) (t = n[r]).specified && o.setAttribute(t.nodeName, t.nodeValue);
            return o.style.cssText = e.style.cssText, o;
        }
        function d(e) {
            for (var t, n = e.split("{"), o = n.length, i = RegExp("(^|[\\s,>+~])(" + r().join("|") + ")(?=[[\\s,>+~#.:]|$)", "gi"), a = "$1" + T + "\\:$2"; o--; ) (t = n[o] = n[o].split("}"))[t.length - 1] = t[t.length - 1].replace(i, a), 
            n[o] = t.join("}");
            return n.join("{");
        }
        function m(e) {
            ...
            return !N || e.printShived || (void 0 === s[T] && s.add(T), l.attachEvent("onbeforeprint", function() {
                t();
                ...
                })(o), clearTimeout(a._removeSheetTimer), a._removeSheetTimer = setTimeout(t, 500);
            }), e.printShived = !0), e;
        }
        var h, v, y = e.html5 || {}, S = /^<|^(?:button|map|select|textarea|object|iframe|option|optgroup)$/i, C = /^(?:a|b|code|div|fieldset|h1|h2|h3|h4|h5|h6|i|label|li|ol|p|q|span|strong|style|table|tbody|td|th|tr|ul)$/i, E = "_html5shiv", b = 0, _ = {};
        !function() {
            try {
        ...
        e.html5 = x, u(t);
        var w = /^$|\b(?:all|print)\b/, T = "html5shiv", N = !v && function() {
            var n = t.documentElement;
            return !(void 0 === t.namespaces || void 0 === t.parentWindow || void 0 === n.applyElement || void 0 === n.removeNode || void 0 === e.attachEvent);
        }();
        x.type += " print", (x.shivPrint = m)(t), "object" == typeof module && module.exports && (module.exports = x);
    }(void 0 !== e ? e : this, t);
    var _ = [], x = {
        _version: "3.6.0",
        _config: {
    ...
    var N, T = function() {
        ...
        return function(e, t) {
            var o;
            return !!e && (t && "string" != typeof t || (t = a(t || "div")), !(o = (e = "on" + e) in t) && r && (t.setAttribute || (t = a("div")), 
            t.setAttribute(e, ""), o = "function" == typeof t[e], t[e] !== n && (t[e] = n), 
            t.removeAttribute(e)), o);
        };
    }();
    x.hasEvent = T, Modernizr.addTest("ambientlight", T("devicelight", e)), function() {
        var e = {}.hasOwnProperty;
        N = o(e, "undefined") || o(e.call, "undefined") ? function(e, t) {
    ...
    var j = "Moz O ms Webkit", P = x._config.usePrefixes ? j.toLowerCase().split(" ") : [];
    x._domPrefixes = P;
    x.prefixedCSSValue = function(e, t) {
        var n = !1, o = a("div").style;
        if (e in o) {
            var i = P.length;
            for (o[e] = t, n = o[e]; i-- && !n; ) o[e] = "-" + P[i] + "-" + t, n = o[e];
        }
        return "" === n && (n = !1), n;
    };
    var k = x._config.usePrefixes ? j.split(" ") : [];
    x._cssomPrefixes = k;
    var A = function(t) {
        var r, o = w.length, i = e.CSSRule;
    ...
    var $ = x.prefixed = function(e, t, n) {
        return 0 === e.indexOf("@") ? A(e) : (-1 != e.indexOf("-") && (e = l(e)), t ? y(e, t, n) : y(e, "pfx"));
    };
    x.prefixedCSS = function(e) {
        var t = $(e);
        return t && u(t);
    }, x.testAllProps = function(e, t, r) {
        return y(e, n, n, t, r);
    }, function() {
        var e, t, n, r, i, s;
        for (var l in _) if (_.hasOwnProperty(l)) {
            if (e = [], (t = _[l]).name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length)) for (n = 0; n < t.options.aliases.length; n++) e.push(t.options.aliases[n].toLowerCase());
    ...
    }(), r(C), delete x.addTest, delete x.addAsyncTest;
