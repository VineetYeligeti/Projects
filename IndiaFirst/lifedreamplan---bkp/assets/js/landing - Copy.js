...
const labels = ['1Years', '2Years', '3Years', '4Years', '5Years', '6Years','7Years', '8Years', '9Years', '10-30 \nYears',];
...
let myChart = new Chart(ctx, {
    ...
    options: {
        ...
        xAxes: [{
          ...
          scaleLabel: {
            display: true,
            labelString: '*During the given  policy term user will get Life Cover benefit of ₹560,000 ',
            fontColor:"#2A2A2A",
            fontSize: 14,
          },
            gridLines: {
