...
function inputAnimation() {
  ...
  $("input.textBox").focus(function (index, el) {
    if ($(this).val() == "") {
      ...
      $(this)
        .siblings(".effectLabel")
        .find(".placeHolder")
        .addClass("placeholderFocus");
    }
  });
...
function faqAccord() {
  $(".accord h3, .accord .accord-wrap").on("click", function () {
    if ($(this).hasClass("active")) {
      ...
      $(".accordContent")
        .slideUp()
        .siblings("h3, .accord-wrap")
        .removeClass("active");
      $(this)
        .parent()
        .find("h3, .accord-wrap")
        .addClass("active")
        .siblings(".accordContent")
        .slideDown();
...
function receiveIncomeSelect() {
  $(".defferIncome [data-toggle=popover]").popover({
    html: true,
    trigger: "hover",
    content: function () {
  ...
  $(document.body).on("change", "#receiveIncomeFrom", function (e) {
    var optVal = $("#receiveIncomeFrom option:selected").val();
    if (optVal == "year_01") {
      $(".defferIncome").popover("destroy");
      $(".defferIncome .popover-body").html(
        "1. Get base Income from the end of the 1st policy year till the end of policy paying term.</br> 2. Receive an increase in base premium basis the term you opt for i.e., 6,8 and 10 years.</br> 3. Get fixed regular income after the end of policy paying term i.e., after 6th, 8th or 10th year."
      );
      $(".defferIncome").popover("show");
    } else if (optVal == "year_05") {
      $(".defferIncome").popover("destroy");
      $(".defferIncome .popover-body").html(
        "1. Get base Income from the end of 5th policy year till the end of policy paying term.</br> 2. Receive an increase in base premium basis the term you opt for i.e., 6,8 and 10 years.</br> 3. Get fixed regular income after the end of policy paying term i.e., after 6th, 8th or 10th year."
      );
      $(".defferIncome").popover("show");
    } else if (optVal == "year_10") {
      $(".defferIncome").popover("destroy");
      $(".defferIncome .popover-body").html(
        "1. Get the loyalty bonus at the end of 3rd and 10th year. End year will change as per the ppt.</br> 2. Receive an increase in base premium basis the term you opt for i.e., 6,8 and 10 years </br> 3. Get fixed regular income after the end of policy paying term i.e., after 6th, 8th or 10th year"
      );
      $(".defferIncome").popover("show");
    }
  });
