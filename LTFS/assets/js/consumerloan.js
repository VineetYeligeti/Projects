...
$(document).ready(function () {
    ...
    applyEase();
    empowerConsumerLoan();
    knowMoreConsumerLoan();
    doMoreTabs();
    // serviceTab();
    tabs();

    // All The Functon below the commet is called for Consumer Tabs
    ...
    $(document).on('click', '#consumertabs .service-list-item', function () {
        $('html, body').animate({
            scrollTop: $("#consumertabs").offset().top - 80
        }, 200);
    });
});
...
// Empowering Goals Starts from here -------------->
function empowerConsumerLoan() {
...
// Empowering Golas End ----------------------------->


//  Know More Consumer Loans ------------------------>
function knowMoreConsumerLoan() {
...
//  Know More Consumer Loans End --------------------->

// Do more Consumer loan Tabs ------------------------>
function doMoreTabs() {
...
// This code is used for range sliders in the calculatar tabs
function tabs() {
    $(document).on('click', '.at-your-service .service-list li', function (e) {
        //e.preventDefault();
        // alert('tab');
...
function nhresetAmount() {
    document.querySelector("#nhresetData").addEventListener("click", (event) => {
        ...
        $('#nhloan-Requirement-range').val(50000).trigger('input').trigger('change');
...
// Consumer Calculator Tabs Ends Here -------------------------------------------------------------------------------------------------------------------------->